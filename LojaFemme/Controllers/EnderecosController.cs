...
namespace LojaFemme.Controllers
{
    public class EnderecosController : Controller
    {
        ...
        public EnderecosController(LojaFemmeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EnderecoId,Rua,Cidade,Estado,Cep")] Endereco endereco)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnderecoId,Rua,Cidade,Estado,Cep")] Endereco endereco)
        {
