...
namespace LojaFemme.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        public AdministradorsController(LojaFemmeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AdministradorId,Nome,Email,Telefone,DataNascimento,Cpf")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdministradorId,Nome,Email,Telefone,DataNascimento,Cpf")] Administrador administrador)
        {
